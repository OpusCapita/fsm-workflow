## [v0.0.1](Mon, 05 Feb 2018 07:38:14 GMT)
 - #24 Implement runMigrations() and createModel() (Andrei Mourzenkov <mourzenkov@scand.com>, 370a2e8)
 - Docs corrections (Andrei Mourzenkov <mourzenkov@scand.com>, 5c1011d)
 - Docs corrections (Andrei Mourzenkov <mourzenkov@scand.com>, 7698173)
 - #24 Some renamings (Andrei Mourzenkov <mourzenkov@scand.com>, 644a56a)
 - #24 Renamings in DB columns (Andrei Mourzenkov <mourzenkov@scand.com>, 8f21b0d)
 - #24 Corrected documentation (Andrei Mourzenkov <mourzenkov@scand.com>, e7da2f7)
 - #24 Corrected documentation (Andrei Mourzenkov <mourzenkov@scand.com>, f633758)
 - #24 Add publish/release info (Andrei Mourzenkov <mourzenkov@scand.com>, e1434ec)
 - #24 Update documentation (Andrei Mourzenkov <mourzenkov@scand.com>, baa160b)
 - #24 Add 'umzug' to package.json (Andrei Mourzenkov <mourzenkov@scand.com>, 8e62d29)
 - Fix #24 (Andrei Mourzenkov <mourzenkov@scand.com>, 1857a11)
 - #24 Implement addHistory/searchHistory functions (Andrei Mourzenkov <mourzenkov@scand.com>, 81ce452)
 - #24 Work-in-progress (Andrei Mourzenkov <mourzenkov@scand.com>, 55a48f1)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, 95698f9)
 - Merge pull request #18 from kvolkovich-sc/master
    
    Add handle delete button in StateNode and Transition inspectors (e3c3233 1c9b150, a69c125)
 - Add handle delete button in StateNode and Transition inspectors (Kirill Volkovich <kirill.volkovich@jcatalog.com>, 1c9b150)
 - Merge pull request #17 from kvolkovich-sc/master
    
    Merge fsm/gui (0c8f972 8db2748, e3c3233)
 - Fix gui deps versions (Kirill Volkovich <kirill.volkovich@jcatalog.com>, 8db2748)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, 0c8f972)
 - Fixing test results publishing (Alexey Sergeev <sab@scand.com>, 781deac)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, 6ab333d)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, 9846ff1)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, a2e2af0)
 - Update README.md (Alexey Sergeev <asergeev-sc@users.noreply.github.com>, 781972c)
 - Advancing version after release [skip ci] (Alexey Sergeev <sab@scand.com>, 194226b)
 - Set state node label to 'Unnamed' if no name specified (Kirill Volkovich <volkovich@scand.com>, 803568d)
 - Set transition label to 'Unnamed transition' if no name specified (Kirill Volkovich <volkovich@scand.com>, a253069)
 - Fix - can't delete StateNode (Kirill Volkovich <volkovich@scand.com>, 8d14845)
 - Update dependency (Kirill Volkovich <volkovich@scand.com>, 9fda4ee)

## [v0.0.3](Thu, 24 Aug 2017 08:39:24 GMT)
 - Releasing 0.0.3 version (Alexey Sergeev <sab@scand.com>, 2250437)
