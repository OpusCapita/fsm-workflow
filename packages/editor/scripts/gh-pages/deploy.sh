...
urlencode() {
  node -e "console.log('${*}'.replace('/', '-').replace('#', '-'))"
}
...
rm -rf "../../branches/${SAFE_GIT_BRANCH}/editor"
mkdir -p "../../branches/${SAFE_GIT_BRANCH}/editor"

# copy over or recompile the new site
cp -r ./$SITE_SOURCE/* "../../branches/${SAFE_GIT_BRANCH}/editor"
